...
Stable **1.3.0** and Dev **1.0.152-dev** are deployed from the same reviewed source. This release fixes live settings refresh, advances the short-rest clock in discrete steps, simplifies vision ownership, changes module defaults, and presents a collapsible changelog. See the [release record and short test checklist](docs/RELEASE_20260909_SUITE_1_3_0.md). Standalone **Three-Dragon Ante 0.2.3-dev** is also deployed: complete bilingual card effects, public-card inspection, local coin/draw/flip sounds, power introductions dismissed by clicking the screen and source-card glow while choices remain pending. It retains the original vector artwork and automatic tutorial opponents. [Install the optional card table](https://obr.dnd.center/three-dragon-ante-dev/manifest.json) and use its [release record and test checklist](docs/RELEASE_20260909_THREE_DRAGON_0_2_3.md). Music Studio remains online. Complete English XLSX downloads and character-server parser patches remain outside this release.
