...
独立三龙牌 **0.2.0-dev** 已于 16:30 发布，包含原矢量卡画与三维拖拽牌桌，27/27 个公网文件核验通过；两渠道设置都提供此独立测试版地址。[三龙牌发布记录与测试清单](RELEASE_20260909_THREE_DRAGON_0_2_0.md)。Music Studio 未再修改。完整英文 XLSX 与角色卡服务器补丁未发布。同一房间只启用一个 Suite 通道。
