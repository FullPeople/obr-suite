...
独立三龙牌 **0.2.1-dev** 已于 17:28 发布，修正教学自动推进、原位翻牌与金币顺序、合法落点、悬停归位和悬浮提示；27/27 个公网文件核验通过。两渠道设置都提供此独立测试版地址。[三龙牌发布记录与测试清单](RELEASE_20260909_THREE_DRAGON_0_2_1.md)。Music Studio 未再修改。完整英文 XLSX 与角色卡服务器补丁未发布。同一房间只启用一个 Suite 通道。
