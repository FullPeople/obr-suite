...
独立三龙牌 **0.2.3-dev** 已于 18:58 发布，能力说明改为点击屏幕后关闭，教学对手等待阅读结束再行动；27/27 个公网文件核验通过。两渠道设置均提供此独立测试版地址。[发布记录与快速测试](RELEASE_20260909_THREE_DRAGON_0_2_3.md)。此前 [0.2.2-dev](RELEASE_20260909_THREE_DRAGON_0_2_2.md) 的完整说明、公开牌查看、音效及光边保留。Music Studio 未修改。完整英文 XLSX 与角色卡服务器补丁未发布。同一房间只启用一个 Suite 通道。
