...
export interface BossPreferences { hidden: boolean; reducedMotion: boolean }
...
export function getBossPreferences(): BossPreferences {
  ...
  return { hidden: saved.hidden === true, reducedMotion: typeof saved.reducedMotion === "boolean" ? saved.reducedMotion :
