...
const translations = {
  en: {
    ...
    loading: "Loading...",
    expandPanel: "Expand initiative panel",
    collapsePanel: "Collapse",
    dragPanel: "Drag panel",
    placeHere: "Place here",
    pickCard: "Click to pick up this card",
    cancelPick: "Click again to cancel",
    swapCard: "Click to swap with this card",
    rollDisadvantageTitle: "Disadvantage (2d20, use the lower result)",
    rollNormalTitle: "Normal (1d20)",
    rollAdvantageTitle: "Advantage (2d20, use the higher result)",
    endTurnTitle: "End the current turn and advance to the next",
  ...
  zh: {
    ...
    cancelPick: "再次点击取消",
    swapCard: "点击与这张卡交换位置",
    rollDisadvantageTitle: "劣势（2d20 取较低）",
    rollNormalTitle: "普通（1d20）",
    rollAdvantageTitle: "优势（2d20 取较高）",
    endTurnTitle: "结束当前回合，进入下一个",
    addFirst: "请先添加角色",
