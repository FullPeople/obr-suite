...
const pages: readonly { zone: OnboardingZone; eyebrow: Words; title: Words; body: Words; tip: Words; caption: Words; steps?: readonly Words[]; results?: readonly Words[]; glossary: readonly GlossaryTerm[] }[] = [
  ...
  { zone: 'ownFlight', eyebrow: ['第二步：轮流出牌', 'Step 2: Take turns'], title: ['轮到你时出一张牌', 'Play one card on your turn'],
    body: ['轮到你时，把一张手牌拖到自己的牌阵，正面朝上放下。如果你是本轮第一个出牌的人，你刚出的这张牌就发动自己的能力。否则，比较你刚出的牌和右边玩家本轮出的那张牌：你的点数相同或更低，就发动你这张牌的能力；点数更高则通常不发动。比较的是这两张牌，不是双方整副牌阵；不会因此再次发动对方的牌。', 'On your turn, drag one hand card to your flight and place it face up. If you play first this round, your new card triggers its own power. Otherwise, compare your new card with the card your right-hand player played this round. Equal or lower strength triggers your card; higher strength normally does not. Compare those two cards, not your whole flights. This does not trigger your opponent’s card again.'],
    results: [['例如右边玩家本轮出 7 点：你出 5 点或 7 点，就发动你刚出的牌的能力。', 'If the player on your right played strength 7 this round, your strength 5 or 7 card triggers its own power.'], ['同样面对 7 点，你出 9 点时通常不发动能力，但这张牌仍留在你的牌阵中计分。', 'Against that same strength 7, your strength 9 card normally does not trigger, but it still stays in your flight and counts toward your total.']],
    ...
    glossary: [{ term: ['牌阵', 'Flight'], meaning: ['你在本轮局已公开打出的牌。', 'The face-up cards you played this gambit.'] }, { term: ['触发', 'Trigger'], meaning: ['满足条件，让这张牌发动自己的能力。', 'Meet the condition for this card to use its own power.'] }, { term: ['右邻', 'Right-hand player'], meaning: ['按顺时针顺序，在你之前行动的玩家。', 'The player before you in clockwise order.'] }] },
