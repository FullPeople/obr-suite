...
const out=process.env.WORKBENCH_RESOURCE182_OUT||'F:/CodexWork/2026-09-20/w-xu/workbench-resource-182';mkdirSync(out,{recursive:true});
...
const entry=resolve('tools/workbench-resource-182-entry.ts');
...
const currentRoomCopies=structuredClone(docs);const writesSeen=[],sharedDocs=new Map();let blockedId='',release,waiting=false;const reads=[];
