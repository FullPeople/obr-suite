...
const out=process.env.WORKBENCH_RESOURCE183_OUT||'F:/CodexWork/2026-09-20/w-xu/workbench-resource-183';mkdirSync(out,{recursive:true});
...
const entry=resolve('tools/workbench-resource-183-entry.ts');
